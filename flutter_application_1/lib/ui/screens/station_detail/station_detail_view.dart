...
class StationDetailView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ChangeNotifierProvider(
      create: (_) => StationDetailViewModel(station: station),
...
class _StationDetailBody extends StatelessWidget {
  ...
  void _navigateToBooking(BuildContext context, StationDetailViewModel vm) {
    final index = vm.selectedSlotIndex!;
    final slot = vm.station.slots[index];
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) =>
            BookingView(station: vm.station, slot: slot, bike: slot.bike!),
      ),
    );
  }
              ...
              Expanded(
                child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    final isSelected = vm.selectedSlotIndex == index;

                    return InkWell(
                      onTap: hasBike ? () => vm.selectSlot(index) : null,
                      child: Container(
                        color: isSelected
